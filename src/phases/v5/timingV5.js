...
export function computeTimelineV5(p) {
  ...
  const phase4Start = 0.47, phase4End = 0.68;
  const phase5Start = 0.68, phase5End = 0.82;
  const phase6Start = 0.82, phase6End = 0.94;
  const phase7Start = 0.94, phase7End = 1.00;
  ...
  const phase4T = smoothstep(ramp(p, phase4Start, phase4End));
